...
class GraphHyperEdgesAPH:
    def __init__(self):
        with tf.compat.v1.name_scope("GraphHyperEdgesA"):
...
class GraphHyperEdgesBPH:
    def __init__(self):
        with tf.compat.v1.name_scope("GraphHyperEdgesB"):
...
class GraphEdgesPH:
    def __init__(self, nonzero = False):
        with tf.compat.v1.name_scope("GraphEdges"):
...
class GraphPlaceholder():
    def __init__(self):
        with tf.compat.v1.name_scope("GraphPlaceholder"):
